...
export function showBanner(content, type, duration=5000){
    ...
    if (!notification_wrapper) {
        const popup = `<dialog id="notification_wrapper" popover="manual"></dialog>`
   ...
   const icons = {
        ...
        // info: `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M440-280h80v-240h-80v240Zm40-320q17 0 28.5-11.5T520-640q0-17-11.5-28.5T480-680q-17 0-28.5 11.5T440-640q0 17 11.5 28.5T480-600Z"/></svg>`,
...
function injectCss(){
    if(document.querySelector(`[id="wuefl_banner"]`)) return;
    const cssLink = `<link id="wuefl_banner" rel="stylesheet" href="./banner.css">`;
