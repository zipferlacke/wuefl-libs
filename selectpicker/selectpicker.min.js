...
class PickerBase {
    ...
    injectCss(){
        if(document.querySelector(`[id="wuefl_pickerselect"]`)) return;
        const cssLink = `<link id="wuefl_pickerselect" rel="stylesheet" href="./pickerselect.css">`;
 ...
 */
class SelectPicker extends PickerBase {
    /**
     * @type {SelectInstance[]}
     */
    activePickers;
